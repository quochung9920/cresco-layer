...
final class Assets {
	...
	public function enqueue_editor_scripts(): void {
		...
		wp_enqueue_script( 'cresco-layer-ai-context-policy', CRESCO_LAYER_URL . 'assets/ai-context-policy.js', [ 'cresco-layer-semantic-design-contract' ], CRESCO_LAYER_VERSION, false );
		...
		wp_enqueue_script( 'cresco-layer-ai-panel', CRESCO_LAYER_URL . 'assets/ai-panel.js', [ 'cresco-layer-visual-verification' ], CRESCO_LAYER_VERSION, false );
