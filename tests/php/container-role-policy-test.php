...
c_assert(true === $roles['outer']['paddingPolicy']['pageGutter'], 'only section shell owns page gutter');
c_assert(false === $roles['content']['paddingPolicy']['pageGutter'], 'content does not repeat page gutter');
