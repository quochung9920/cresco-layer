...
d_assert(0===$out['settings']['layout']['containerPadding']['desktop']['fixedPx'],'global padding upgraded');
d_assert(!isset($out['settings']['layout']['containerPadding']['desktop']['fluid']),'old nested padding definition removed by policy');
