...
p_assert([ 'mobile'=>767,'tablet'=>960,'laptop'=>1200,'desktop'=>1400,'widescreen'=>1500 ] === ResponsiveLayoutPolicy::content_widths(), 'widths');
p_assert([
	'mobile'=>'phone',
	'tablet'=>'tablet',
	'laptop'=>'laptop-13-14',
...
] === ResponsiveLayoutPolicy::device_intent(), 'device intent');
...
p_assert(ResponsiveLayoutPolicy::device_intent() === $contract['deviceIntent'], 'device intent exported');
...
p_assert('1400px' === ResponsiveLayoutPolicy::token_map()['--cresco-container-max'], 'desktop token');
